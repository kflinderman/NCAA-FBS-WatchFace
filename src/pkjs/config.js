...
// Define your short testing list
const testTeamOptions = [
  { "label": "Clemson", "value": 0 },
  { "label": "South Carolina", "value": 1 }
];

// Define the full lists
const fullTeamOptions = [
  { "label": "ACC", "value": 0 },
...
// Dynamically assign the arrays and defaults based on the flag
const activeFullOptions = IS_TESTING ? testTeamOptions : fullTeamOptions;
const activeApliteOptions = IS_TESTING ? testTeamOptions : apliteTeamOptions;
const DEFAULT_FAVORITE = IS_TESTING ? 1 : 108; // South Carolina
const DEFAULT_BEAT = IS_TESTING ? 0 : 26; // Clemson
    ...
    "items": [
	    ...
	    },
      {
      ...
      },
	    {
		    ...
		    "defaultValue": DEFAULT_FAVORITE,
		    "label": "Favorite Team",
        "capabilities": ["NOT_PLATFORM_APLITE"],
		    "options": activeFullOptions
	    },
	    {
		    "type": "select",
		    "messageKey": "FavoriteTeam",
